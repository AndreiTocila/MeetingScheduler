class SqlQuery:
    ...
    select_all_meetings = 'SELECT meetings.start_date, meetings.end_date, persons.name, persons. surname FROM meetings join participants on meetings.id = participants.meeting_id join persons on persons.id = participants.person_id'
